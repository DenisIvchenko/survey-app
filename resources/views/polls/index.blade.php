                    ...
                    <div class="relative bg-white dark:bg-[#1a1a20] rounded-2xl border border-gray-200 dark:border-white/10 hover:shadow-2xl transition-all duration-300 overflow-visible"
                        ...
                        <div class="p-5 bg-white dark:bg-[#1a1a20] relative z-10 rounded-b-2xl">
                            <div class="flex items-start justify-between gap-2 mb-2">
                                <h3 class="text-lg font-bold text-gray-900 dark:text-white truncate flex-1 min-w-0">{{ $poll->title }}</h3>
                                @if ($poll->surveyRating && (float) $poll->surveyRating->avg_rating > 0)
                                    <a href="{{ route('polls.reviews', $poll) }}"
                                       ...
                                       title="Смотреть отзывы">
                                        ★ {{ number_format((float) $poll->surveyRating->avg_rating, 1) }}
                                    </a>
                                @endif
                            </div>
